...
package com.tim.saga.demo.springcloud.account.controller;
...
public class AccountController {
	...
	public Boolean cancel(@RequestBody AccountDTO accountDO) {
		return accountService.cancelPayment(accountDO);
	}
